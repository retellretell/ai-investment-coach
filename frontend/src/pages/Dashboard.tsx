  ...
  return (
    <div className="space-y-6">
      <div className="bg-white rounded-lg shadow p-6">
        <h1 className="text-3xl font-bold mb-2">AI 투자주치의</h1>
        <p className="text-gray-600">투자, 공부보다 습관이 더 중요합니다</p>
      </div>
      ...
      <div className="bg-blue-50 border-l-4 border-blue-500 p-4 rounded">
        <p className="text-lg font-medium text-blue-900 mb-2">오늘의 AI 코칭</p>
        <p className="text-blue-800">{analysis?.behavior_summary}</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="space-y-4">
          <h3 className="text-xl font-bold">추천 행동</h3>
